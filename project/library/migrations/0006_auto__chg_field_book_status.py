...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('library_book', 'status', self.gf('django.db.models.fields.SmallIntegerField')(max_length=2))

    def backwards(self, orm):

        # Changing field 'Book.status'
        db.alter_column('library_book', 'status', self.gf('django.db.models.fields.CharField')(max_length=2))
